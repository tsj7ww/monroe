...
import { Search, Database, FileText, HardDrive, Calendar, User, Tag, BarChart3 } from 'lucide-react';
...
const DataSourceMetadata = ({ dataSource, type }) => {
  ...
  const ExistingDataSourceSearch = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Metadata Display */}
        <DataSourceMetadata dataSource={selectedDataSource} type={activeTab} />
      </div>
    );
  };

  export default ExistingDataSourceSearch;